...
// setup 
add_action( 'plugins_loaded', 'sm_plugin_textdomain_register' );

function sm_plugin_textdomain_register() {
	$plugin_rel_path = 'mymovies/lang';
    load_plugin_textdomain( 'mymovies', false, $plugin_rel_path );
...
include(SM_PATH.'/process/add_movie_ajax.php');
include(SM_PATH.'/inc/admin/dashboard_widget.php');
...
add_action('wp_ajax_sm_add_movie_action', 'procress_ajax_of_add_movie_by_user');
add_action('wp_ajax_nopriv_sm_add_movie_action', 'procress_ajax_of_add_movie_by_user');
add_action('wp_dashboard_setup', 'sm_my_movie_dashboard_widgets');
