...
function sm_front_end_style_n_scripts(){
	...
	wp_enqueue_style('bootstapcss', plugins_url( '/assets/css/bootstrap.min.css', SM_URL ));
	wp_enqueue_script('bootstapjs', plugins_url( '/assets/js/bootstrap.min.js', SM_URL ), array('jquery')  );
